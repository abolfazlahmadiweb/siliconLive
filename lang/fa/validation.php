...
return [
    ...
    'attributes'           => [
        ...
        'another'                  => 'عنوان برای ما',
        'published_at'                  => 'تاریخ بروزرسانی',
        'code1' => 'کد اول',
        'code2' => 'کد دوم',
        'code3' => 'کد سوم',
        'code4' => 'کد چهارم',
        ...
        'expert' => 'تخصص',
        'private' => 'خصوصی کردن پروفایل',
        'comment' => 'اعلان نظرات',
        'link' => 'باز کزدن لینک در تب جدید',
        'mute' => 'شروع بی صدا ویدیو',
        'auto' => 'پخش خودکار ویدیو',
        'discussion' => 'اعلانات پرسش و پاسخ',
        'video' => 'ذخیره خودکار زمان مشاهده',
        'g-recaptcha-response' => 'من ربات نیستم',
        'authentication' => 'کد',
        'custom' => [
            'g-recaptcha-response' => [
                'required' => 'لطفا تایید کنید که شما ربات نیستید',
                'captcha' => 'خطای کپچا،لطفا مجدد بررسی کنید',
            ],
        ],
    ],
];
