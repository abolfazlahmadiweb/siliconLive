    ...
    <form wire:submit.prevent="register">
        ...
        <div class="group">
            ...
            <div class="os-input">
                ...
                <input wire:model="name" type="text" id="name" name="name" class="os-bg @error('name') error @enderror"
            ...
            <div class="os-input">
                ...
                <input wire:model="email" type="email" id="email" name="email"
                       class="os-bg @error('email') error @enderror" placeholder="ایمیل خود را وارد کنید">
                @error('email')
                <p class="error_text os-light"> {{$message}} </p>
                @enderror
            </div>
        ...
        <div class="os-input">
            ...
            <input wire:model="phone" type="text" id="phone" name="phone" class="os-bg @error('phone') error @enderror"
        ...
        <div class="group">
            ...
            <div class="os-input">
                ...
                <input wire:model="password_confirmation" type="password" id="password2" name="password_confirmation"
                       class="os-bg" placeholder="رمز عبور را مجدد وارد کنید">
            </div>
            <!-- input os -->
        </div>
        <!-- group -->
